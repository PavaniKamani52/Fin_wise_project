# FinWise — Setup & Deployment Guide
...
2. Click **New Project**, name it `finwise`, pick a region
...
```bash
git clone https://github.com/Sridattasai18/FinWise.git
cd FinWise
```
...
Render will give you a public URL like `https://finwise-backend.onrender.com`. Copy it.
...
Vercel will give you a production URL like `https://finwise.vercel.app`.
...
FinWise is created for educational and informational purposes. The metrics and recommendation models do not constitute professional financial or legal counsel. Consult a qualified advisor before negotiating with creditors.
