...
The backend test suite covers settlement calculation logic, Gemini AI fallback behaviour, settlement API endpoints, and safe E2E flows. There are **74 tests** across four files.
